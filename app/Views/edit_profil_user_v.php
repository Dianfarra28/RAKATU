        ...
        <div class="col-md-4">
         <div >
          ...
          <button class="open-button" onclick="openForm()"><i class="fas fa-pencil-alt"></i>&nbsp Ubah Foto Profil</button>
            ...
            <div class="form-popup user" id="myForm">
              <form action="process_user" class="form-container" method="post">
        ...
        <form action="updateuser" method="post">
          ...
          <div class="row">
            <div class="col">
              ...
              <input type="text" class="form-control" placeholder="Username" value="<?php echo $id_user; ?>" name="username" readonly>
            </div>
             &nbsp  &nbsp
          ...
          <div class="form-group">
            ...
            <input type="password" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Konfirmasi Password Lama"  name="password">
          </div>
