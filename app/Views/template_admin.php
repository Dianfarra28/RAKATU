        ...
        <span class="navbar-toggler-icon"></span>
          ...
          <div  class="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                <a class="navbar-brand" href="<?php echo base_url('Dashboard/index_admin'); ?>"><h5>RAKATU</h5></a>
            </ul>
            <div>
                <ul class="nav justify-content-end">
                  <li class="<?php if(($title == 'Home | RAKATU') or ($title =='Welcome | RAKATU')) { echo 'active'; } ?>">
                    <a class="nav-link" href="<?php echo base_url('Dashboard/index_admin'); ?>">Home</a>
                  </li>
                  <?php if(session()->get('logged_in')){ ?>  
                      <li class="<?php if($title == 'Materi') { echo 'nav-item dropdown active'; } else{echo 'nav-item dropdown'; }?>">
                        <a class="nav-link" href="<?php echo base_url('Dashboard/menu'); ?>">Materi</a>
                      </li>
                      <li class="<?php if($title == 'FlashCard | RAKATU') { echo 'active'; } ?>">
                        <a class="nav-link" href="<?php echo base_url('FlashCard/kartuAdmin'); ?>">FlashCard</a>
                      </li>
                      <li class="<?php if($title == 'Ujian | RAKATU') { echo 'active'; } ?>">
                        <a class="nav-link" href="<?php echo base_url('Dashboard/ujian_admin'); ?>">Ujian</a>
                      </li>
                      <li class="<?php if($title == 'Log In | RAKATU' or $title == 'Sign Up | RAKATU') { echo 'active'; } ?>">
                      <li class="<?php if($title == 'About Us | RAKATU') { echo 'active'; } ?>">
                        <a class="nav-link" href="<?php echo base_url('Dashboard/kontak_admin'); ?>">About Us</a>
                      </li>
                      <div class="dripdown">
                       <button class="dropbtn in"><img src="<?php echo $foto ?>" style="max-width: 30px; max-height: 30px; border-radius: 50%;">&nbsp &nbsp<?php echo $namadepan ?></button>
                        <div class="dropdown-content bar">
                          <a href="<?php echo base_url('Dashboard/ProfilAdmin'); ?>"><i class="fas fa-user-cog"></i> &nbsp  &nbsp  Profil</a>
