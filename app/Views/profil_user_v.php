        ...
        <div class="col-md-4">
          ...
          <button class="open-button" onclick="openForm()"><i class="fas fa-pencil-alt"></i>&nbsp Ubah Foto Profil</button>
            ...
            <div class="form-popup user" id="myForm">
              <form action="process_user" class="form-container" method="post" enctype="multipart/form-data" >
        ...
        <form action="editProfilUser" method="post">
          ...
          <div class="row">
            <div class="col">
              ...
              <input type="text" class="form-control" placeholder="Username" value="<?php echo $id_user; ?>" readonly>
            </div>
             &nbsp  &nbsp
